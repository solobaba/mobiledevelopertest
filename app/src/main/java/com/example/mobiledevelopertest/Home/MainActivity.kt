...
import com.example.mobiledevelopertest.Competitions.Competition
...
import com.example.mobiledevelopertest.Home.Competitions.CompetitionAdapter
import com.example.mobiledevelopertest.Home.Fixtures.FixtureAdapter
    ...
    private fun callFixtureDB() {
        ...
        doAsync {
            ...
            uiThread {
                ...
                var fixtureAdapter =
                    FixtureAdapter(this@MainActivity, listfootball, homePresenter::onFixtureItemClicked)
    ...
    private fun callCompetitionDB() {
        ...
        doAsync {
            ...
            uiThread {
                ...
                var homeAdapter =
                    CompetitionAdapter(this@MainActivity, listfootball, homePresenter::onCompetitionItemClicked)
