...
class CompetitionFixtureAdapter() :
    androidx.recyclerview.widget.RecyclerView.Adapter<CompetitionFixtureAdapter.MyViewHolder>() {
    ...
    constructor(
        context: Context?,
        competitionTeamList: MutableList<CompetitionFixtureModel>?,
        listener: (Int, MutableList<CompetitionFixtureModel>) -> Unit
    ) : this() {
